	...
	return (
		<main style={pageStyles}>
			...
			<ul style={doclistStyles}>
				{documentLinks.map(document_ => (
					<li key={document_.url} style={documentLinkStyle}>
						<a
							style={linkStyle}
							href={`${document_.url}?utm_source=starter&utm_medium=ts-docs&utm_campaign=minimal-starter-ts`}
						>
							{document_.text}
						</a>
					</li>
